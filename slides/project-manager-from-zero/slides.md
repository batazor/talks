...
<img src="./images/intro.png" style="width: 100%; margin: 0 auto;" />
...
к своему первому проекту. **Но реальность отличается**
...
<img src="./images/catch.jpeg" style="width: 40%; margin: 0 auto;" />
...
- Почему _управлять проектами_ — **непростая задача**.
- Почему _проектное управление_ — **ключ к** будущему **росту компании**.
- Почему у _проектного управления_ **светлое будущее** 
  и почему получение сертификата проектного менеджера может 
  быть мудрым **шагом в карьере**.
- Каковы _последние тенденции_ в проектном управлении, 
...
получения уникального результата. Это означает, что он имеет _четко
определенное начало и конец_ и результат работы отличается от всего,
...
> Институт управления проектами (**PMI**) определяет проект как
временную деятельность для производства уникального продукта или услуги.

---

# Что есть Операционная деятельность?
...
### Сравнение проектов и операционной деятельности
...
# Управление проектами. Научный взгляд
...
# Описание групп процессов проектного управления
...
# Отношения между группами процессов
...
## Описание областей знаний проектного управления
...
# В чем состоит ценность проектного управления для компании?
...
# В чем состоит ценность проектного управления для меня лично?
